...
export const ResearchConfig = () => {
    ...
    const handleSaveConfig = () => {
        ...
        toast({
            title: "Success",
            description: "Research configuration has been successfully updated.",
            variant: "default",
        });
    };
        ...
        <div className="space-y-8 p-6">
            ...
            <Collapsible className="pb-px -mb-px pt-px -mt-px" open={state.researchType === "specific"}>
                <CollapsibleContent className="data-[state=closed]:animate-slideUp data-[state=open]:animate-slideDown overflow-hidden">
                    <div className="space-y-2">
                        <label htmlFor="influencer-name" className="text-sm font-semibold opacity-0 animate-fadeIn">
                            Influencer Name
                        </label>
                        <Input
                            id="influencer-name"
            ...
            <div className="flex justify-end">
                <Button
                    ...
                    className="w-full md:w-fit bg-emerald-500 hover:bg-emerald-600 text-white font-bold"
                >
                    Save Configuration
                </Button>
            </div>
